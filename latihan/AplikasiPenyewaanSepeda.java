...
import javax.swing.*;
class AplikasiPenyewaanSepeda extends JFrame
{
 ...
 JRadioButton waktuC=new JRadioButton("6 Hari");
...
setVisible(true);
 ...
 void komponenVisual()
 {
     ...
     getContentPane().add(waktuC);
     waktuC.setBounds(280,50,70,20);
     lamawaktu.add(waktuA);
     lamawaktu.add(waktuB);
     lamawaktu.add(waktuC);
     ...
     tbllanjut.setBounds(10,190,90,20);
     
     getContentPane().add(tblbatal);
     tblbatal.setBounds(110,190,90,20);
     
     getContentPane().add(tblkeluar);
     tblkeluar.setBounds(210,190,90,20);

     getContentPane().add(lblsk);
     lblsk.setBounds(140,220,190,20);
